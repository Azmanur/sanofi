									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<button class="btn btn-primary"><a href="update-order.php?oid=<?php echo htmlentities($row['id']); ?>" title="Update order" target="_blank">Edit</a></button>
													<button class="btn btn-danger"><a href="delete_order.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete this order?')"><i class="icon-remove-sign"></i>Delete</a></button>
												</td>

...
<head>
    <title>Sanofi - User Sign Up</title>
...
<body style="background-color: #e4e4e4;">
    ...
    <div class="global-container">
        <div style="background-color: rgb(164, 220, 255);" class="card login-form">
            <div class="card-body">
                <h3 class="card-title text-center" style="color:black; font-weight: bold;">Sign Up To Sanofi</h3>

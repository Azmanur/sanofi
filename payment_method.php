                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <img src="https://www.logo.wine/a/logo/BKash/BKash-Icon2-Logo.wine.svg" class="rounded float-left" alt="..." height="200px" width="200px" ;>
                                <input type="radio" name="paymethod" value="bkash" checked="checked"> Bkash

                                <img src="https://www.logo.wine/a/logo/Nagad/Nagad-Vertical-Logo.wine.svg" class="rounded" alt="..." height="200px" width="200px">
                                <input type="radio" name="paymethod" value="Nagad"> Nagad


                                <hr>

                                <img src="https://5.imimg.com/data5/NX/QH/SF/SELLER-78615388/cash-on-delivery-jpg-500x500.jpg" class="rounded" alt="..." height="200px" width="200px">

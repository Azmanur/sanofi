...
<body id="top">
    ...
    <div class="container">
        <h1 style="text-align:center; margin-top:20px; color:#223A66;">Welcome To <span style="color:red;">Sanofi</span></h1>
    </div>
    <br>
    <div class="container">
                        ...
                        ?>
                            <form action="" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" value="<?php echo $row['shipping_address']; ?>" name="shipping">
                                    </div>
                                </div>
                                <div class="form-group row">
